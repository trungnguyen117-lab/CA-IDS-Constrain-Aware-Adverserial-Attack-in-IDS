...
def load_training_config(model_name, config_dir=None):
    """Load training YAML config and return as dict.
    If config_dir is given, load from that directory instead of default."""
